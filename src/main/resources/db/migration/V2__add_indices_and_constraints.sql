...
ALTER TABLE user_roles
  ADD CONSTRAINT uk_user_role_app UNIQUE (user_id, role_id, app_id);
...
ALTER TABLE user_roles
  ADD CONSTRAINT user_roles_app_id_fkey
  FOREIGN KEY (app_id) REFERENCES applications(app_id) ON DELETE CASCADE;

ALTER TABLE rolepermissions
  ADD CONSTRAINT rolepermissions_role_id_fkey
  FOREIGN KEY (role_id) REFERENCES roles(role_id) ON DELETE CASCADE;

ALTER TABLE rolepermissions
  ADD CONSTRAINT rolepermissions_permission_id_fkey
...
ALTER TABLE login_logs
  ADD CONSTRAINT login_logs_app_id_fkey
  FOREIGN KEY (app_id) REFERENCES applications(app_id) ON DELETE CASCADE;
